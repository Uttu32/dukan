...
import QuestionMark from "../assets/SvgFiles/QuestionMark.svg";
import SearchIcon from "../assets/SvgFiles/SearchIcon.svg";

export default function Header() {
  return (
    <div className="flex inter w-full justify-between items-center px-6 py-2 bg-white">
      <div className="flex  items-center gap-4">
        <p className="text-[0.9375rem] font-[400] text-[#1A181E]">Payments</p>
        <span className="flex gap-[0.375rem] items-center text-[0.75rem] font-[400] text-[#4D4D4D] ">
          <img className="w-[0.875rem] h-[0.875rem]" src={QuestionMark} alt="" />
          How it works
        </span>
      </div>
      {/* searchbar  */}
      <div className="relative rounded-[0.375rem] w-[33%]">
        <input className="rounded-[0.375rem] pl-10 border-b bg-[#F2F2F2] outline-none border-[#D9D9D9] w-full py-2" type="text" placeholder="Search features, tutorials, etc." />
        <img className="absolute top-3 left-4 cursor-pointer" src={SearchIcon} alt="" />
      </div>
      {/* last section  */}
      <div className="flex items-center gap-4">
        <div className="w-[2.5rem] h-[2.5rem] flex justify-center items-center bg-[#E6E6E6] rounded-[5rem]">
          <svg
        ...
        <svg
          ...
          fill="none"
        >
          <g clip-path="url(#clip0_12143_2537)">
